...
add_vw = 'address_vw'
ap.MakeTableView_management(sde_add,
                            add_vw,
                            address_sql)
ap.AddJoin_management(add_vw,
                      'PROPERTY_PFI',
                      multi_vw,
                      'PFI')
ap.CalculateField_management(add_vw,
                             'UNQ_LBL',
                             "'Y'",
                             'PYTHON')
